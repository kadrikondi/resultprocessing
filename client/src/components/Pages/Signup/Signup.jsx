...
<div className="card mt-5" id="signup">
    <div className="card-body">
        ...
        <div  className="card-header black-text text-center py-4">
            <h3><a href="index.html" class="brand-link">
       ...
       <div class="md-form">
        ...
        <div className="md-form">
        <p className='p-1'>  <input type="checkbox"  className="" required="required"/> I agree to <Link to='/terms'>terms</Link> and <Link to='/c'>conditions</Link> of ResultProcessing</p>
        </div>
   ...
   (<div className="alert alert-danger"id="info">{this.state.info}</div>)} 
        ...
        <div className="text-center">
            ...
            <button className="btn btn-info btn-block" style={{color: 'rgb(235,235,235)'}}  onClick={this.handleSubmit}> &nbsp;Sign up  
